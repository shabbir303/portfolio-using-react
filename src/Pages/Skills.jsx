            ...
            <div className="flex items-center  ">
                <div className="w-[50%] border-r-[1px] border-gray-700  pb-[20px]">
                    <div className="p-[25px] flex items-center gap-3   mx-auto border-b-[1px] border-gray-600 ">
                        <h1 className="w-[40px] h-[40px] border-[2px] text-center text-[35px] border-amber-500 text-amber-500 rounded-full"><IoCodeSlash /></h1> <h1 className="uppercase text-[25px] font-bold text-white">Coding</h1>
                    </div>
                ...
                <div className="w-[50%]  pb-[20px]">
                    ...
                    <div className="mt-[26px] w-[80%] mx-auto">
                        ...
                        <p className="flex px-5  items-center gap-2"><TiTick className="text-amber-700 text-[20px]"/><h1 className="text-[20px] font-semibold text-stone-500">Learning and Adaptability</h1> </p>
                    </div>
                </div>
            </div>
        </>
